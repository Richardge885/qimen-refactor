...
function paiFeiPan({ year, month, date, hour, minute, nianzhu, yuezhu, rizhu, shizhu, jieqi, dun, jushu, }, additionalSetting, baoshuMethod, baoshu, ziXuanJu) {
    ...
    let wangGong = '';
    let result = initializeJiuGong(year, month, date, hour, minute, nianzhu, yuezhu, rizhu, shizhu, jieqi, dun, jushu, xunShou, fuShi.zhifu, fuShi.zhishi, baoshuMethod, baoshu, ziXuanJu);
    let i = 0;
...
function initializeJiuGong(year, month, date, hour, minute, nianzhu, yuezhu, rizhu, shizhu, jieqi, dun, jushu, xunShou, zhiFu, zhiShi, baoshuMethod, baoshu, ziXuanJu) {
    return {
        allTimeInformation: {
            year: year,
            month: month,
