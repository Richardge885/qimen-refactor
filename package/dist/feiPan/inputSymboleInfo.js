...
exports.inputSymboleInfo = inputSymboleInfo;
const feiPanGeJu_1 = require("./feiPanGeJu");
function inputSymboleInfo(panJu, shiZhi) {
    let result = panJu;
    Object.keys(result).forEach((object) => {
        const gong = result[object];
        switch (gong.baGua) {
            default:
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.qian;
                break;
            case "坎":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.kan;
                break;
            case "艮":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.gen;
                break;
            case "震":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.zhen;
                break;
            case "巽":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.xun;
                break;
            case "离":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.li;
                break;
            case "坤":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.kun;
                break;
            case "兑":
                gong.symboleInfo.gong = feiPanGeJu_1.baGuaInfo.dui;
                break;
        }
        switch (gong.xing) {
            default:
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianPeng;
                break;
            case "天芮":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianRui;
                break;
            case "天冲":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianChong;
                break;
            case "天辅":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianFu;
                break;
            case "天禽":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianQin;
                break;
            case "天心":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianXin;
                break;
            case "天柱":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianZhu;
                break;
            case "天任":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianRen;
                break;
            case "天英":
                gong.symboleInfo.xing = feiPanGeJu_1.xingInfo.tianYing;
                break;
        }
        ...
        switch (gong.men) {
            default:
                ...
                break;
            case "死门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.siMen;
                break;
            case "伤门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.shangMen;
                break;
            case "杜门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.duMen;
                break;
            case "中五":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.zhongMen;
                break;
            case "开门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.kaiMen;
                break;
            case "惊门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.jinMen;
                break;
            case "生门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.shengMen;
                break;
            case "景门":
                gong.symboleInfo.men = feiPanGeJu_1.menInfo.jingMen;
                break;
        }
        switch (gong.tianPanShen) {
            default:
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.zhiFu;
                break;
            case "螣蛇":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.tengShe;
                break;
            case "太阴":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.taiYin;
                break;
            case "六合":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.liuHe;
                break;
            case "白虎":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.baiHu;
                break;
            case "勾陈":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.gouChen;
                break;
            case "太常":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.taiChang;
                break;
            case "玄武":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.xuanWu;
                break;
            case "朱雀":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.zhuQue;
                break;
            case "九地":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.jiuDi;
                break;
            case "九天":
                gong.symboleInfo.shen = feiPanGeJu_1.shenInfo.jiuTian;
                break;
        }
        switch (gong.tianPanGan) {
            default:
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.yi;
                break;
            case "丙":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.bing;
                break;
            case "丁":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.ding;
                break;
            case "戊":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.wu;
                break;
            case "己":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.ji;
                break;
            case "庚":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.geng;
                break;
            case "辛":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.xin;
                break;
            case "壬":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.ren;
                break;
            case "癸":
                gong.symboleInfo.tianPanGan = feiPanGeJu_1.ganInfo.gui;
                break;
        }
        switch (gong.diPanGan) {
            default:
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.yi;
                break;
            case "丙":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.bing;
                break;
            case "丁":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.ding;
                break;
            case "戊":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.wu;
                break;
            case "己":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.ji;
                break;
            case "庚":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.geng;
                break;
            case "辛":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.xin;
                break;
            case "壬":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.ren;
                break;
            case "癸":
                gong.symboleInfo.diPanGan = feiPanGeJu_1.ganInfo.gui;
                break;
        }
    });
    return result;
