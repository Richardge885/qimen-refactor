...
exports.getMaXing = getMaXing;
exports.gongWangShuai = gongWangShuai;
exports.findXunShouGan = findXunShouGan;
exports.paiDiPanGan = paiDiPanGan;
exports.zhaoXunShou = zhaoXunShou;
exports.dingFuShi = dingFuShi;
exports.dingKongWang = dingKongWang;
exports.paiAnGanZhi = paiAnGanZhi;
exports.rearrangeArray = rearrangeArray;
function getKongWang(xunShou, wantYiKong) {
    let gongKong = [0, undefined, ""];
    let yiKong;
    switch (xunShou) {
        default:
            gongKong[0] = 0;
...
function gongWangShuai(jieqi, feiPan) {
    if (feiPan) {
...
function findXunShouGan(xunshou) {
    switch (xunshou) {
        default:
            return "戊";
        case "甲戌":
...
function paiAnGanZhi(xunshou, diPanGanList, dun) {
    let anGanZhiList;
    let xunShouLiuYi;
    let anGanZhiStartingPosition = 0;
    if (dun == "阳") {
        switch (xunshou) {
            default:
                anGanZhiList = [
...
function rearrangeArray(array, startIndex, dun = "阳") {
    if (dun == "阴") {
