...
const calendarData: CalendarEntry[] = data as CalendarEntry[];

export function timeInfo(date: string, time: string, method = '', number = 0) {
    let i = 0;
...
function getShiZhu(date: string, hour: string) {
